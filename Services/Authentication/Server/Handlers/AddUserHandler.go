...
func (h *AddUserHandler) Event() string {
	return Events.ADD_USER_EVENT
}

func (h *AddUserHandler) Execute(command Commands.Command) error {
...
func (h *AddUserHandler) OnSubscribe() {
...
func (h *AddUserHandler) OnUnsubscribe() {
	h.Client = nil
	h.Context = nil
